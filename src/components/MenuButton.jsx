...
const MenuButton = ({ showMenu, setShowMenu }) => {
  ...
  return (
    <div className="">
      ...
      <div
        className={`fixed inset-0 mt-16 flex  w-[22rem] flex-col gap-6 overflow-y-scroll bg-black pt-12 font-semibold  duration-300 xl:hidden ${showMenu ? "translate-y-0" : "translate-y-[-110%]"}`}
      >
