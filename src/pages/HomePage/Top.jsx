  ...
  return (
    <div className="h-[400px] overflow-hidden md:h-[1000px] lg:h-[800px] 2xl:h-[850px]">
      {programs.map((item) => (
        <div
          key={item.id}
          className={`relative z-0 h-[360px] md:h-[900px] lg:h-[50vh] xl:h-[70vh] 2xl:h-[80vh] w-full${counter === item.id ? "" : " hidden"}`}
        >
          <div className="relative h-full  ">
            ...
            <img
              ...
              alt="photo_top"
            />
            <div className="absolute left-0 top-[75%] w-full -translate-y-1/2 transform text-center text-3xl font-bold text-white md:top-[85%] md:text-5xl lg:top-[50%] lg:pl-4 lg:text-left lg:text-4xl 2xl:pl-8">
            ...
            <div className=" bottom-10 mx-4 flex h-12 w-full items-center justify-center pt-4 lg:relative lg:h-12 lg:w-full lg:justify-start lg:pr-6">
              {programs.map((item) => (
                <div
                  key={item.id}
                ...
                >
                  ...
                  <img
                    src={item.photo}
                    className={`hidden h-3/4 w-full rounded-2xl   ${counter === item.id ? "bg-white" : "bg-transparent"} object-cover p-[1px] shadow-md hover:bg-white lg:block`}
                    alt="photo_select"
                    onClick={() => setCounter(item.id)}
                  />
                </div>
