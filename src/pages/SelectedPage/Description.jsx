  ...
  return (
    <div className="mx-4 mb-4">
      ...
      <div className="w-full text-xl">
        ...
        <div
          className={`relative ${showWiecej ? "h-full" : "h-[5rem]"} grid grid-cols-2 overflow-hidden text-sm md:h-full`}
        >
          <h1 className=" mb-4 mt-8 hidden text-xl font-semibold md:block">
            Opis serialu
          </h1>
          <h1 className=" mb-4 ml-8 mt-8 hidden text-xl font-semibold md:block">
          ...
          <div className="ml-8 hidden flex-col gap-4 md:flex">
            ...
            <h1>Tagi:</h1>
            <button className="cursor-pointer rounded-lg border-2 border-playerColor bg-transparent px-4 py-2 font-medium text-playerColor  hover:border-gray-200 hover:bg-gray-200 hover:text-black">
              Lorem ipsum
            </button>
            <button className="cursor-pointer rounded-lg border-2 border-playerColor bg-transparent px-4 py-2 font-medium text-playerColor  hover:border-gray-200 hover:bg-gray-200 hover:text-black">
              Lorem ipsum
